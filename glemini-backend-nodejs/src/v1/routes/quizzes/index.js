...
router.post('/upload', uploadQuizzes.single('file'), asynHandler(quizController.uploadQuiz));

router.post('/docs/upload', uploadDocs.single('file'), asynHandler(quizController.uploadDoc));

router.post('/md/upload', uploadDocs.single('file'), asynHandler(quizController.uploadMd));

router.post('/txt/upload', uploadDocs.single('file'), asynHandler(quizController.uploadTxt));
...
router.post('/gemini/generate/prompt', asynHandler(quizController.geminiCreateQuestionByPrompt));
router.post(
...
router.post('/get-all-quizzes-shared', asynHandler(quizController.getAllQuizShared));
router.post('/remove-quiz-shared', asynHandler(quizController.removeQuizShared));
router.post('/copy-quiz', asynHandler(quizController.copyQuiz));
router.post('/get-all-user-shared', asynHandler(quizController.getAllSharedUser));
router.post('/remove-user-shared', asynHandler(quizController.removeSharedUser));
router.post('/get-newest-quizzes', asynHandler(quizController.getNewestQuizzes));
