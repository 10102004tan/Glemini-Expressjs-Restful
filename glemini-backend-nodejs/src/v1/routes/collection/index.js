...
router.post('/get-details', asynHandler(collectionController.getCollectionById));
router.post('/add-quiz', asynHandler(collectionController.addQuizToCollection));
router.post('/remove-quiz', asynHandler(collectionController.removeQuizFromCollection));
